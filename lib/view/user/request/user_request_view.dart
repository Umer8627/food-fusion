...
import 'package:food_fusion/view/user/request/widgets/user_add_request_popup.dart';
import 'package:food_fusion/view/user/request/widgets/user_request_widget.dart';
            ...
            children: [
              ...
              StreamBuilder(
                stream: ProductRepo.instance
                    .getProductRequestById(FirebaseAuth.instance.currentUser!.uid),
